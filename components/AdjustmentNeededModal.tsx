...
interface AdjustmentNeededModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmitJustification: (justification: string) => void;
}

const AdjustmentNeededModal: React.FC<AdjustmentNeededModalProps> = ({
  isOpen,
  onClose,
  ...
  const handleSubmit = () => {
    if (!justification.trim()) {
      setError('Os detalhes do ajuste são obrigatórios para esta ação.');
      return;
    }
    setError('');
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="adjustment-needed-modal-title"
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="Descreva quais ajustes são necessários para esta solicitação."
              required
